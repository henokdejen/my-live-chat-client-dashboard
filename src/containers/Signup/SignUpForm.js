  ...
  const handleSignUp = (e) => {
    ...
    if (props.password && props.email && passwordRe && agree) {
      if (validateEmail(props.email)) {
        ...
        if (props.password != passwordRe)
          e.target.setCustomValidity("The passwords don't match!");
  ...
  return (
    <div className="flexcontainer">
      <div className="adcontainer">
        <p>
          {" "}
          Amazing app, super well built at an incredibly fair price. Needed some
          support in switching stores and the support was absolutely brilliant.
          Well done guys!
          <br />
          <br /> someone
        </p>
        ...
        <form>
          <div className="inputfield-container">
            ...
            <label className="box-container">
              ...
              <p>
                I agree to These's{" "}
                <span className="termslink">Terms & Conditions</span> and{" "}
                <span className="termslink">Privacy Policy</span>
              </p>
            </label>
