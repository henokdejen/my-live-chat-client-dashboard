...
export const VisitorDetail = () => {
    const techonology = [
        ...
        },
        {
            ...
            'vlaue': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.135 Safari/537.36',
        },
            ...
            <Card>
                ...
                {[1,2,3].map( (site, index) => (
                    <div className="visited-site-item" key={index}>
                        ...
                        <a className="v-s-l" href="#">https://blog.campvanilla.com/reactjs-dropdown-menus-b6e06ae3a8fe</a>
                    </div>
                )
