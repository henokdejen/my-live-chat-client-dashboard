...
import { messagesLoaded, conversationsLoading, conversationLoaded } from '../actions';
...
export const conversationsSaga = function*() {
    yield put(conversationsLoading())

    // const {response, error} = yield call(loadConversations)
